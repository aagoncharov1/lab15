...
![Рисунок 1](screenshots15\lab15.1.png){ #fig:001 width=70% }
...
![Рисунок 2](screenshots15\lab15.2.png){ #fig:002 width=70% }
...
![Рисунок 3](screenshots15\lab15.3.png){ #fig:003 width=70% }

![Рисунок 4](screenshots15\lab15.4.png){ #fig:003 width=70% }
...
![Рисунок 5](screenshots15\lab15.5.png){ #fig:004 width=70% }

Makefile (файл для сборки) не изменял (рис. -@fig:005)

![ Рисунок 6](screenshots15\lab15.6.png){ #fig:005 width=70% }

После написания кодов, я, используя команду «make all», скомпилировал необходимые файлы (рис. -@fig:006) 

![Рисунок 7](screenshots15\lab15.7.png){ #fig:006 width=70% }
...
![ Рисунок 8](screenshots15\lab15.8.png){ #fig:008 width=70% } 
...
![ Рисунок 9](screenshots15\lab15.9.png){ #fig:010 width=70% } 
